...
//  Warning: none
//------------------------------------------------------------------------------
unsigned char LINClass::init (unsigned char l_type, unsigned long b_rate, unsigned long l_mode) {
...
//  Warning: none
//------------------------------------------------------------------------------
unsigned char LINClass::tx_header (unsigned char l_type, unsigned char l_id, unsigned char l_len) {
...
//  Warning: none
//------------------------------------------------------------------------------
unsigned char LINClass::rx_response (unsigned char l_type, unsigned char l_len) {
...
//           - l_len: True length (not coded), number of data bytes transported
//                          in the response. This information is not used in
//                          銑IN_1X・because it is coded in l_id・
//
//  The function returns:
//           == 0 : Initialization failed, LIN type is not in accordance
...
//  Warning: none
//------------------------------------------------------------------------------
unsigned char LINClass::tx_response (unsigned char l_type, unsigned char *l_data, unsigned char l_len) {
...
//  Warning: none
//------------------------------------------------------------------------------
void LINClass::get_response (unsigned char *l_data) {
